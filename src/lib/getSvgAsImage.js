// getSvgAsImage.js
const { getBrowserCanvasMaxSize } = require('./getBrowserCanvasMaxSize'); // Asegúrate de importar los módulos necesarios
const { PngHelpers } = require('./png'); // Asegúrate de importar los módulos necesarios
...
module.exports = { getSvgAsImage, getSvgAsDataUrl, getSvgAsDataUrlSync };