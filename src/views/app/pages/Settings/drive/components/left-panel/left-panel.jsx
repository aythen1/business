  ...
  return (
    <div>
      ...
      <div className={style.drive_options_container}>
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20" ><g ><path fill="#A365F6" d="M11.59 3.72a.526.526 0 0 0-.96-.422l-4.056 8.02c-.154.288-.064.536.228.536l2.271-.015c.38 0 .38.194.248.684l-.94 3.858c-.13.64.69.863 1.001.287l4.071-8.06a.301.301 0 0 0-.252-.462l-2.36.01a.236.236 0 0 1-.243-.309z"></path><path fill="#4F0599" d="M17.5 14.5A1.5 1.5 0 0 1 16 16h-2.616a.3.3 0 0 1-.29-.373l.311-1.248A.5.5 0 0 1 13.89 14h1.61V6h-1.616a.3.3 0 0 1-.29-.373l.311-1.248A.5.5 0 0 1 14.39 4H16a1.5 1.5 0 0 1 1.5 1.5zm-15-9A1.5 1.5 0 0 1 4 4h3.116a.3.3 0 0 1 .29.373l-.31 1.247A.5.5 0 0 1 6.61 6H4.5v8h1.616a.3.3 0 0 1 .29.373l-.311 1.248A.5.5 0 0 1 5.61 16H4a1.5 1.5 0 0 1-1.5-1.5z" clipRule="evenodd" fillRule="evenodd"></path></g></svg>
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20" ><g ><path fill="#4F0599" d="M3 5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zm12 0H5v10h10z" clipRule="evenodd" fillRule="evenodd"></path><path fill="#A365F6" d="M8 7a1 1 0 0 1 1 1v4a1 1 0 0 1-2 0V8a1 1 0 0 1 1-1m4 0a1 1 0 0 1 1 1v4a1 1 0 0 1-2 0V8a1 1 0 0 1 1-1" clipRule="evenodd" fillRule="evenodd"></path></g></svg>
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20" ><g ><g ><path fill="#A365F6" d="M10.024 12.797c-2.89 0-6-.841-6-2.69h1.444c.084.32 1.612 1.187 4.556 1.187s4.473-.867 4.557-1.196l1.443.01c0 1.848-3.11 2.69-6 2.69Z" ></path><path fill="#4F0599" d="M16.497 5.532c0-.01.003-.018.003-.028C16.5 3.44 13.13 2.5 10 2.5s-6.5.94-6.5 3.004c0 .02.005.037.006.057v8.952h.003c.018 2.052 3.373 2.987 6.493 2.987 3.114 0 6.461-.932 6.49-2.977h.005zM10 4.5c2.576 0 4.085.65 4.444 1.004-.359.353-1.868 1.003-4.444 1.003-2.576 0-4.085-.65-4.444-1.003C5.915 5.15 7.425 4.5 10 4.5m.002 11c-2.797 0-4.335-.768-4.489-1.003h-.002V7.75c1.242.512 2.895.757 4.489.757 1.595 0 3.25-.246 4.492-.758v6.679c-.207.328-1.734 1.072-4.49 1.072" ></path></g></g></svg>
