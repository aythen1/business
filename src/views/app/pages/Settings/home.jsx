...
import ModalDNS from '../../components/ModalDNS'
            ...
            <div className={styles["headerContact"]}>
                ...
                {false && (
                    <div className={styles["peopleKnow"]}>
                        <div className={styles["topKnow"]}>
                            <b>
                                Personas que quizás conozas
                            </b>
                            <button>
                                Ver todas
                            </button>
            ...
            <div>
                <div className={styles["containerBanner"]}>
                    ...
                    <div className={styles['cards']}>
                        ...
                        {listVector.slice(0, 2).map((vector, index) => (
                            // <div
                            //     key={index}
