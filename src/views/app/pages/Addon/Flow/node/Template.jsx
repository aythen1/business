...
const Template = ({
    ...
    //
    const [panel, setPanel] = useState('leftTop')
    ...
    const handleClickAddComponent = async () => {
        ...
        setListComponents(prevList => [
            ...prevList,
            {
                id: prevList.length + 1, // Asigna un nuevo ID único
                text: randomComponent.description, // Usa el componente aleatorio
                image
            }
        ]);
    };
    ...
    const handleDoubleClickTemplate = () => {
        alert(1)
        navigate(`/${'es'}/app/addon/${'ddf97681-ca79-465d-bab2-c1c366dc0d2b'}/editor/${'-'}`)
    }
    ...
    return (
        <div className={styles.container}>
            {(panel == 'leftTop' || panel == 'rightTop') ? (
                <div className={`${styles.panel} ${styles['panel-' + panel]}`}>
                    ...
                    <div className={styles.search}>
                        <div className={styles.inputSearch}>
                            ...
                            {isImage ? (
                                <button onClick={() => handleClickViewImage()}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                ...
                                <button onClick={() => handleClickNoneImage()}>
                    ...
                    <div >
                        <div
                            ...
                            onClick={() => setPanel('leftTop')}
                        />
                        <div
                            className={styles.leftBottom}
                            onClick={() => setPanel('leftBottom')}
                        />
                        <div
                            className={styles.rightTop}
                            onClick={() => setPanel('rightTop')}
                        />
                        <div
                            className={styles.rightBottom}
                            onClick={() => setPanel('rightBottom')}
                        />
                    </div>
                </div>
            ) : (
                <div className={styles.nonePanel}>
                    ...
                    <button onClick={() => setPanel('leftTop')} >
                        Open Panel
                    </button>
                </div>
            )}
